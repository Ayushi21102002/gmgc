...
<head>
    ...
    <link rel="stylesheet" href="../gmgc/Bootstrap/CSS/bootstrap.css">
    <link rel="stylesheet" href="../gmgc/Bootstrap/CSS/bootlogin.css">
                ...
                <form id="log" style="background-color: white; width: 100%;" >
                    <div class="row" style=" border-radius: 5px; background-color:rgb(200, 194, 194);">
                     <div class="text-center">
                        <img src="../gmgc/Bootstrap/admissionform/logo12.png" alt="" style="width: 80px; border-radius: 100%; margin-top: 15px;;" >
                    </div>
                    <h3 style=" font-size:25px; margin-left: 10px; color: BLACK;">Gyanmanjari Group Of Colleges. </h3>
                    </div>
                     <br> 
                    <div class="form-group" > 
                        <label style="font-weight: bolder; font-size: 18px; float:left; color: black; font-size: 20px; margin-right: 20px; ">Select Type:</label>

...
$q = "SELECT * FROM `be_inquiry` WHERE email='khushi@gmail.com'";
...
?>
        <form action="../transaction_edit/gmit_edit.php" method="post">
        <div class="row" style="background:white; border-radius:10px; margin:20px; ">
    <div class="text-center">
    ...
    <div class="row" style="margin-top:20px;">
        <div class="col">
            <div class="text-center" style="margin-bottom: 10px;">
                <button id="submit" type="submit" name="trans1" class="btn btn-danger">SUBMIT</button>
            </div>
        </div>
    </div>

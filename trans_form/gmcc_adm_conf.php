...
?>
        <form action="../transaction_edit/gmcc_edit.php" method="post">
        <div class="row" style="background:white; border-radius:10px; margin:20px; ">
    <div class="text-center">
                    ...
                    <div class="col-md-8">
                        <span style="display:block; overflow:hidden;">
                            <input type="text" class="form-control" placeholder="Branch Name" name="branch"
                                style="border-color: black; width: 70%; " value="<?php echo $gcourse; ?>">
                    </div>
                    </span>
                </div>
            </div>
    ...
    <div class="row" style="margin-top:20px;">
        <div class="col">
            <div class="text-center" style="margin-bottom: 10px;">
                <button id="submit" type="submit" name="trans6" class="btn btn-danger">SUBMIT</button>
            </div>
        </div>
    </div>

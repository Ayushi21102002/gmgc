...
$q = "SELECT * FROM `diplo_inquiry` WHERE email='$email'";
...
?>
        <form action="../transaction_edit/gmdc_edit.php" method="post">
        <div class="row" style="background:white; border-radius:10px; margin:20px; ">
    <div class="text-center">
    ...
    <div class="row" style="margin-top:20px;">
        <div class="col">
            <div class="text-center" style="margin-bottom: 10px;">
                <button id="submit" type="submit" name="trans3" class="btn btn-danger">SUBMIT</button>
            </div>
        </div>
    </div>

...
$preen="SELECT * FROM `bpharm_inquiry` ORDER BY enrollment desc limit 1";
  ...
  while ($row = mysqli_fetch_array($sql)) {
    ...
    // $conn = mysqli_connect("localhost", "root", "", "gmgc");
    $query = "UPDATE `bpharm_inquiry` SET `enrollment`='$enroll' WHERE id='$id' ";
